      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 md:px-8 lg:px-5 xl:px-20 py-16 sm:py-20 md:py-24 lg:py-[120px] flex flex-col items-center text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
          <Button
            ...
            className="bg-dark-gray text-white px-8 py-4 rounded-lg font-semibold hover:bg-gray-800 transition-all hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]"
          >
            {primaryButtonText}
          </Button>
          {secondaryButtonText && (
            <Button
              ...
              variant="outline"
              className="bg-white text-dark-gray px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-all hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] border-dark-gray"
            >
              {secondaryButtonText}
            </Button>
          )}
